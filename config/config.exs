...
config :elx_mcp, ElxMcpWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ElxMcpWeb.ErrorHTML, json: ElxMcpWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: ElxMcp.PubSub,
  live_view: [signing_salt: "VjhTRSxR"]
...
config :elx_mcp, ElxMcp.Mailer, adapter: Swoosh.Adapters.Local
